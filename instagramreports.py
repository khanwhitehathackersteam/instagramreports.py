#The Credit For This Code Goes To Khan white hat hackers team 
...
nu = 0
n = 0
br = pyfiglet.figlet_format("KHAN")
print(B+br)
print('''
...
if  'authenticated":true' in r.text or 'userId' in r.text:
    ...
    print ("")
    os.system ("xdg-open https://www.facebook.com/groups/khanhackerteam/?ref=share#FF002A")
    print(G+"*"*25)	
    print("")
